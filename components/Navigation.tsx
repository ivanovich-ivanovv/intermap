      ...
      <div className="max-w-7xl mx-auto px-6 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-white-700 hover:text-orange-600 transition-colors text-sm font-medium"
            >
              {t.nav.features}
            </a>
            <a
          ...
          >
            <div className="w-5 h-5 flex flex-col justify-center space-y-1">
              <span
                className={`block h-0.5 bg-gray-700 transition-all ${mobileMenuOpen ? "rotate-45 translate-y-1.5" : ""}`}
              ></span>
              <span
                className={`block h-0.5 bg-gray-700 transition-all ${mobileMenuOpen ? "opacity-0" : ""}`}
              ></span>
              <span
                className={`block h-0.5 bg-gray-700 transition-all ${mobileMenuOpen ? "-rotate-45 -translate-y-1.5" : ""}`}
              ></span>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="px-6 py-6 space-y-4">
            <a
              href="#features"
              className="block text-gray-700 hover:text-orange-600 text-sm font-medium"
            >
              {t.nav.features}
            </a>
            <a
